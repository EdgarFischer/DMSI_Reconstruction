...
DOMAIN = "xyT"# Input axes that goes into the network (as well as output), 
...
#### Define Model path
if GT_Data == "FullRank":
    model_save_dir = f"../saved_models/Stacked_Unet/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    model_save_dir = f"../saved_models/Stacked_Unet/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
    
#### Define log directory path
if GT_Data == "FullRank":
    log_dir = f"../log_files/Stacked_Unet/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    log_dir = f"../log_files/Stacked_Unet/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
