...
model_save_dir = f'../saved_models/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_T8/{num_convs}Layer'
log_dir = f'../log_files/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_T8/{num_convs}Layer'
...
model = Naive_CNN_3D(grouped_time_steps=grouped_time_steps, num_convs=num_convs, use_batch_norm=False, mask=None).to(device)
