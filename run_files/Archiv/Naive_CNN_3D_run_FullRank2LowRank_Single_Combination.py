...
model_save_dir = f'../saved_models/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_SC/{num_convs}Layer'
log_dir = f'../log_files/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_SC/{num_convs}Layer'

################################

#### load data
Ground_Truth = np.load('../data/Low_Rank_8_P03-P08_masked.npy')
Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08_Low_Rank/Undersampled_possoin_3D_fixed_r{r}_AF_{AF}_Single_Combination.npy') ## Data set with accerleration factor 3
