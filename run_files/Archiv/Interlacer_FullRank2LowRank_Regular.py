...
if SC:
    model_save_dir = f'../saved_models/Interlacer_regular_Full2Low_SC/{num_layers}Layer'
    log_dir = f'../log_files/Interlacer_regular_Full2Low_SC/{num_layers}Layer'
    Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08/Undersampled_Regular_Single_Combination.npy')
    
else:
    model_save_dir = f'../saved_models/Interlacer_regular_Full2Low/{num_layers}Layer'
    log_dir = f'../log_files/Interlacer_regular_Full2Low/{num_layers}Layer'
