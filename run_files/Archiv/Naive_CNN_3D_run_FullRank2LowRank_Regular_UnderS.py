...
if SC:
    model_save_dir = f'../saved_models/Naive_CNN_3D_Regular_Full2Low_SC_{trancuate_t}/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_Regular_Full2Low_SC_{trancuate_t}/{num_convs}Layer'
    Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08/Undersampled_Regular_Single_Combination.npy')
else:
    model_save_dir = f'../saved_models/Naive_CNN_3D_Regular_Full2Low_{trancuate_t}/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_Regular_Full2Low_{trancuate_t}/{num_convs}Layer'
