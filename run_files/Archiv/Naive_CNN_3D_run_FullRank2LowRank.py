...
if SC:
    model_save_dir = f'../saved_models/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_SC_{trancuate_t}/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_SC_{trancuate_t}/{num_convs}Layer'
    Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08/Undersampled_possoin_3D_fixed_r{r}_AF_{AF}_Single_Combination.npy')
else:
    model_save_dir = f'../saved_models/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_{trancuate_t}/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Low_{trancuate_t}/{num_convs}Layer'
    Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08/Undersampled_possoin_3D_fixed_r{r}_AF_{AF}.npy')
################################
