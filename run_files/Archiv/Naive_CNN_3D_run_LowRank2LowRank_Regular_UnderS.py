...
if SC:
    model_save_dir = f'../saved_models/Naive_CNN_3D_Regular_Low2Low_SC/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_Regular_Low2Low_SC/{num_convs}Layer'
    Undersampled_Data = np.load(f'../data/Undersampled_Data_P03-P08_LowRank/Undersampled_Regular_Single_Combination.npy')
else:
    model_save_dir = f'../saved_models/Naive_CNN_3D_Regular_Low2Low/{num_convs}Layer'
    log_dir = f'../log_files/Naive_CNN_3D_Regular_Low2Low/{num_convs}Layer'
