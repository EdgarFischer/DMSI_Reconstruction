...
#### Define Model path
if GT_Data == "FullRank":
    model_save_dir = f"../saved_models/Con_Stacked_Unet/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    model_save_dir = f"../saved_models/Con_Stacked_Unet/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
    
#### Define log directory path
if GT_Data == "FullRank":
    log_dir = f"../log_files/Con_Stacked_Unet/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    log_dir = f"../log_files/Con_Stacked_Unet/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"


#### Define Input Data path
undersampled_data_path = "../visualizations/xyT_Output.npy"
...
if DOMAIN == "kzfT":     
    ...
    #### reshap vectors
    reshape_vector = (0, 1, 4, 3, 2, 5)
    inverse_reshape = (0, 1, 4, 3, 2, 5)
...
aug_data, aug_labels, aug_mask = NN_input_train, ground_truth_train, Train_Mask#transform_6d_data_labels_mask(NN_input_train, ground_truth_train, Train_Mask)
...
model = StackedUNet3D(num_unets=Layers, grouped_time_steps=1, use_batch_norm=False)
