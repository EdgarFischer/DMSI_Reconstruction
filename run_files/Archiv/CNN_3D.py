...
#### Definie Model path
if GT_Data == "FullRank":
    model_save_dir = f"../saved_models/Naive_CNN_3D/"+DOMAIN+"Full2Full/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask+f'/{num_convs}Layer'
elif GT_Data == "LowRank":
    model_save_dir = f"../saved_models/Naive_CNN_3D/"+DOMAIN+"/Low2Low/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask+f'/{num_convs}Layer'
    
#### Define log directory path
if GT_Data == "FullRank":
    log_dir = f"../log_files/Naive_CNN_3D/"+DOMAIN+"/Full2Full/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask+f'/{num_convs}Layer'
elif GT_Data == "LowRank":
    log_dir = f"../log_files/Naive_CNN_3D/"+DOMAIN+"/Low2Low/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask+f'/{num_convs}Layer'
...
Train_Mask, Test_Mask = mask_extended[...,:5], mask_extended[...,5]
...
ground_truth_train, ground_truth_test = ground_truth_train.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1), ground_truth_test.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1)
NN_input_train, NN_input_test = NN_input_train.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1), NN_input_test.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1)

Mask_train, Mask_test = Train_Mask.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1), Test_Mask.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], -1)
