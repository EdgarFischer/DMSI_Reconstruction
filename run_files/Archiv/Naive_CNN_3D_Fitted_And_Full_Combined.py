...
# model_save_dir = f'../saved_models/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}/{num_convs}Layer'
# log_dir = f'../log_files/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}/{num_convs}Layer'

model_save_dir = f'../saved_models/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_CombinedTimsteps_ALL/{num_convs}Layer'
log_dir = f'../log_files/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_CombinedTimsteps_ALL/{num_convs}Layer'
