...
model_save_dir = f'../saved_models/Naive_CNN_3D_AF_{AF}_possoin_r{r}_CombinedTimsteps/{num_convs}Layer'
log_dir = f'../log_files/Naive_CNN_3D_AF_{AF}_possoin_r{r}_CombinedTimsteps/{num_convs}Layer'
...
Undersampled_Data = np.load(f'../data/Undersampled_Data/combined_undersampled_possoin_3D_fixed_r{r}_AF_{AF}_CombinedTimsteps.npy') ## Data set with accerleration factor 3
