...
from Naive_CNN_3D_Residual_No_Batch_Norm import *
...
model_save_dir = f'../saved_models/Naive_CNN_3D_AF_3_Alternating/{num_convs}Layer'
log_dir = f'../log_files/Naive_CNN_3D_AF_3_Alternating/{num_convs}Layer'
...
Undersampled_Data = np.load('../data/Undersampled_Data/combined_undersampled_Alternating_AF_3.npy') ## Data set with accerleration factor 3
