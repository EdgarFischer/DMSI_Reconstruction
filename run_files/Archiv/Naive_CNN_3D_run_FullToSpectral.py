...
model_save_dir = f'../saved_models/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Spectral/{num_convs}Layer'
log_dir = f'../log_files/Fitted_Naive_CNN_3D_AF_{AF}_possoin_r{r}_Full2Spectral/{num_convs}Layer'

################################

#### load data
Ground_Truth = np.load('../data/P04_And_P08_Spectral_Fit.npy')
Undersampled_Data = np.load(f'../data/Undersampled_Data/P04_P08_FullRank_undersampled_possoin_3D_fixed_r{r}_AF_{AF}.npy') ## Data set with accerleration factor 3
