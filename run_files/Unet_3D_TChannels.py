##### NOTE!!! This only works for xyz-T architecture; it is assumed that this is fourier transformed in t -> f.
...
DOMAIN = "xyz"# Input axes that goes into the network (as well as output), 
...
#### Definie Model path
if GT_Data == "FullRank":
    model_save_dir = f"../saved_models/UNet_3D_T/"+DOMAIN+"/Full2Full/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask
elif GT_Data == "LowRank":
    model_save_dir = f"../saved_models/UNet_3D_T/"+DOMAIN+"/Low2Low/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask
    
#### Define log directory path
if GT_Data == "FullRank":
    log_dir = f"../log_files/UNet_3D_T/"+DOMAIN+"/Full2Full/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask
elif GT_Data == "LowRank":
    log_dir = f"../log_files/UNet_3D_T/"+DOMAIN+"/Low2Low/"+Undersampling+f'/AF_{AF}/'+f'Truncate_t_{trancuate_t}/'+Sampling_Mask
...
Undersampled_Data, Ground_Truth, mask_extended  = np.swapaxes(Undersampled_Data, 3, 4), np.swapaxes(Ground_Truth, 3, 4), np.swapaxes(mask_extended, 3, 4)
...
ground_truth_val, ground_truth_test = ground_truth_val.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1), ground_truth_test.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)

NN_input_val, NN_input_test = NN_input_val.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1), NN_input_test.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)

Mask_val, Mask_test = Val_Mask.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1), Test_Mask.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
...
aug_data = aug_data.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
aug_labels = aug_labels.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
aug_mask = aug_mask.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
...
train_data_unaug = train_data_unaug.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
train_labels_unaug = train_labels_unaug.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
train_mask_unaug = train_mask_unaug.reshape(Ground_Truth.shape[0], Ground_Truth.shape[1], Ground_Truth.shape[2], Ground_Truth.shape[3], -1)
