...
#### Define Model path
if GT_Data == "FullRank":
    model_save_dir = f"../saved_models/Swin_Transformer/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    model_save_dir = f"../saved_models/Swin_Transformer/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
    
#### Define log directory path
if GT_Data == "FullRank":
    log_dir = f"../log_files/Swin_Transformer/{DOMAIN}/Full2Full/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
elif GT_Data == "LowRank":
    log_dir = f"../log_files/Swin_Transformer/{DOMAIN}/Low2Low/{Undersampling}/AF_{AF}/Truncate_t_{trancuate_t}/{Sampling_Mask}/Layers_{Layers}"
...
# ------------------------------------------------------------------------
optimizer = optimizer = torch.optim.Adam(model.parameters(), lr=0.00002)#torch.optim.AdamW(model.parameters(), lr=1e-4)#optimizer = torch.optim.Adam(model.parameters(), lr=0.001)
